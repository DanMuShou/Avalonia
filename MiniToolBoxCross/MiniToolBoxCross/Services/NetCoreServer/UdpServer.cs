...
namespace MiniToolBoxCross.Services.NetCoreServer
{
    /// <summary>
    ...
    public class UdpServer : IDisposable
    {
        ...
        public virtual bool MulticastAsync(byte[] buffer, long offset, long size) =>
            MulticastAsync(buffer.AsSpan((int)offset, (int)size));
        ...
        public virtual bool MulticastAsync(ReadOnlySpan<byte> buffer) =>
            SendAsync(MulticastEndpoint, buffer);
        ...
        public virtual bool MulticastAsync(string text) =>
            MulticastAsync(Encoding.UTF8.GetBytes(text));
        ...
        public virtual bool MulticastAsync(ReadOnlySpan<char> text) =>
            MulticastAsync(Encoding.UTF8.GetBytes(text.ToArray()));
        ...
        public virtual long Send(EndPoint endpoint, byte[] buffer, long offset, long size) =>
            Send(endpoint, buffer.AsSpan((int)offset, (int)size));
        ...
        public virtual long Send(EndPoint endpoint, string text) =>
            Send(endpoint, Encoding.UTF8.GetBytes(text));
        ...
        public virtual long Send(EndPoint endpoint, ReadOnlySpan<char> text) =>
            Send(endpoint, Encoding.UTF8.GetBytes(text.ToArray()));
        ...
        public virtual bool SendAsync(EndPoint endpoint, byte[] buffer) =>
            SendAsync(endpoint, buffer.AsSpan());
        ...
        public virtual bool SendAsync(EndPoint endpoint, byte[] buffer, long offset, long size) =>
            SendAsync(endpoint, buffer.AsSpan((int)offset, (int)size));
        ...
        public virtual bool SendAsync(EndPoint endpoint, ReadOnlySpan<byte> buffer)
        {
            ...
            if (
                ((_sendBuffer.Size + buffer.Length) > OptionSendBufferLimit)
        ...
        public virtual bool SendAsync(EndPoint endpoint, ReadOnlySpan<char> text) =>
            SendAsync(endpoint, Encoding.UTF8.GetBytes(text.ToArray()));
        ...
        public virtual long Receive(ref EndPoint endpoint, byte[] buffer, long offset, long size)
        {
            ...
            try
            {
                ...
                long received = Socket.ReceiveFrom(
                    buffer,
                    (int)offset,
                    (int)size,
                    SocketFlags.None,
        ...
        private void SendError(SocketError error)
        {
            ...
            if (
                error
                is SocketError.ConnectionAborted
